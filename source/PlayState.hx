...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
        ...
        var creditTxt:FlxText = new FlxText(4,healthBarBG.y + 20,0,(""), 24);
	...
	override public function update(elapsed:Float)
	{
		...
		if(ratingString == '?') {
			scoreTxt.text = 'Score: ' + songScore + ' | port by newbion | Misses: ' + songMisses + ' | Rating: ' + ratingString;
		} else {
			scoreTxt.text = 'Score: ' + songScore + ' | port by newbion | Misses: ' + songMisses + ' | Rating: ' + ratingString + ' (' + Math.floor(ratingPercent * 100) + '%)';
		}
